...
function hideoutHome() {
  ...
  textDisplay.innerText = "You are in your secret hideout in Paris. Here, you can plan your next heist or go complete small tasks, like going to the store to buy supplies. Hint** you can also steal them. But don't get caught ;). Each tasks gains your confidence which makes tasks easier. Add items to your inventory by buying them in the store, but you can only carry 4 things at one time. You'll need certain items to perform specific tasks, so think before you buy. There are three ways to get in: As a janitor, a band member, or a potential buyer. Select 'Go to club' to study each path. Think critically and good luck!";
